...
router.post('/', authorize(Role.USER, Role.ADMIN), async (req: Request, res: Response) => {
  try {
    const { titleId, rating, content } = req.body as CreateReviewRequest & { titleId: string };
 ...
 */
router.post('/:id/vote', authorize(Role.USER, Role.ADMIN), async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
 ...
 */
router.post('/:id/reply', authorize(Role.USER, Role.ADMIN), async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
