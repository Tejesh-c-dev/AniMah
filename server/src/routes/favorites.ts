 ...
 */
router.delete('/:titleId', authorize(Role.USER, Role.ADMIN), async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/toggle/:titleId', authorize(Role.USER, Role.ADMIN), async (req: Request, res: Response) => {
  try {
    const { titleId } = req.params;
 ...
 */
router.get('/check/:titleId', authorize(Role.USER, Role.ADMIN), async (req: Request, res: Response) => {
  try {
    const { titleId } = req.params;
