 ...
 */
router.delete('/:titleId', authMiddleware, async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/toggle/:titleId', authMiddleware, async (req: Request, res: Response) => {
  try {
    const { titleId } = req.params;
 ...
 */
router.get('/check/:titleId', authMiddleware, async (req: Request, res: Response) => {
  try {
    const { titleId } = req.params;
